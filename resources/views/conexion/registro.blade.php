...
@section('content')
    ...
    <div class="box box_register shadow">
        <div class="header">
            <a href="{{url('/')}}">
                <img src="{{url('/static/img/Logo2.png')}}">
            </a>
        </div>
        <div class="inside">
       ...
       <label for="pass" class="mtop16">Password:</label>
       <div class="input-group">
        <div class="input-group-prepend">
       ...
       <label for="cpass" class="mtop16">Confirmar password:</label>
       <div class="input-group">
        <div class="input-group-prepend">
            <div class="input-group-text"><i class="fas fa-key"></i></div>
          </div>
        {!!Form::password('cpass',['class' => 'form-control','required'])!!}
       </div>
